...
namespace ExampleGame
{
    public class ExampleCharacters
    {
        ...
        public void NewGame(ExampleGameSourceData gameData)
        {
            ...
            Rat1 = GameState.CurrentGameState.AddCharacter(new Rat("Joe the rat", 7, 23) { MaxAttack = 10, CounterAttackChance = 15 }, gameData.EgLocations.Start);
            Rat2 = GameState.CurrentGameState.AddCharacter(new Rat("Henry the rat", 8, 15) { MaxAttack = 12, CounterAttackChance = 17 }, gameData.EgLocations.BanquetHall);
        }
    }
}
