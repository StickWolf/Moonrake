...
namespace Moonrake
{
    public class MoonRakeLocations
    {
        ...
        {
            TreeHouse = gameData.AddLocation(new Location("Tree House", "what looks like a small living space.",
            ...
            Field = gameData.AddLocation(new Location("Field", "a beautifuly trimmed field of lime-green grass and flowers.",
            ...
            IceCreamShop = gameData.AddLocation(new Location("Ice Cream Shop", "an ice cream shop full of people at tables.",
